...
let allHands = [
    `<img class="hands" src="https://github.com/Mrudula-kunathi/Assignment-4-rock-paper-scissors/blob/main/assets/paper-hand.png?raw=true" alt="">`,
    `<img class="hands" src="https://github.com/Mrudula-kunathi/Assignment-4-rock-paper-scissors/blob/main/assets/rock-hand.png?raw=true" alt="">`,
    `<img class="hands" src="https://github.com/Mrudula-kunathi/Assignment-4-rock-paper-scissors/blob/main/assets/scissors-hand.png?raw=true" alt="">`
]
